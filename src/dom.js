...
function ecs (...args) {
	...
	if ( $attr ) {
		forEntriesIn( $attr, function ( key, value ) {
	...
	if ( $dataset ) {
		forEntriesIn( $dataset, function ( key, value ) {
			if ( value instanceof Promise ) {
				value.then( function ( response ) {
	...
	if ( $style ) {
		forEntriesIn( $style, function ( key, value ) {
			if ( value instanceof Promise ) {
				value.then( function ( response ) {
	...
	if ( $actions ) {
		forEntriesIn( $actions, function ( key, values ) {
